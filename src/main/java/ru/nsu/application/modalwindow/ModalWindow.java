...
public class ModalWindow {
    ...
    public ModalWindow(Stage stage, Configuration configuration, Timeline timeline) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/ru/nsu/fxml/modalWindow.fxml"));
        Image icon = new Image(String.valueOf(getClass().getResource("/ru/nsu/images/icon.png").toExternalForm()));
        ...
        try {
            ...
            modalWindowStage.getIcons().add(icon);
