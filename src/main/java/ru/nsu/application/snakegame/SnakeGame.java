...
import ru.nsu.snakegamefx.game.GameController;
import ru.nsu.snakegamefx.game.GameFX;
import ru.nsu.snakegamefx.skin.Skin;
import ru.nsu.snakegamefx.sprite.BoardFX;
import ru.nsu.snakegamefx.sprite.FruitFX;
import ru.nsu.snakegamefx.sprite.SnakeFX;
import ru.nsu.snakegamefx.sprite.WallFX;
...
public class SnakeGame {
    ...
    private void setImages() {
        ...
        images.put("board", new Image(String.valueOf(getClass().getResource("/ru/nsu/images/square.png").toExternalForm())));
        images.put("head", new Image(String.valueOf(getClass().getResource("/ru/nsu/images/snake/head.png").toExternalForm())));
        images.put("rotated", new Image(String.valueOf(getClass().getResource("/ru/nsu/images/snake/rotated.png").toExternalForm())));
        images.put("straight", new Image(String.valueOf(getClass().getResource("/ru/nsu/images/snake/straight.png").toExternalForm())));
        images.put("tail", new Image(String.valueOf(getClass().getResource("/ru/nsu/images/snake/tail.png").toExternalForm())));
        images.put("apple", new Image(String.valueOf(getClass().getResource("/ru/nsu/images/apple.png").toExternalForm())));
    }
    ...
    private void setScene() {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/ru/nsu/fxml/snakeGame.fxml"));
        try {
